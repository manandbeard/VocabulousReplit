...
export default function StudentDashboard() {
  ...
  const streakBgImage = getRotatingImage(userId || 2);
  const achievementBgImage = getRotatingImage((userId || 2) + 3);
      ...
      <div className="space-y-6 font-['Inter']">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div
            ...
            style={{ backgroundColor: "#0f172a", backgroundImage: `url('${streakBgImage}')`, backgroundSize: "cover", backgroundPosition: "center" }}
          >
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <Link href="/student/achievements">
            <div
              ...
              style={{ backgroundColor: "#f5f3ff", backgroundImage: `url('${achievementBgImage}')`, backgroundSize: "cover", backgroundPosition: "center" }}
            >
